...
export default function SettingsPage() {
  ...
  return (
    <>
      ...
      {me.isLoading && <p className="text-sm text-gray-500">Cargando…</p>}
      {me.isError && <ErrorText>{(me.error as Error).message}</ErrorText>}
      {me.data && (
...
function ProfileSection({
  ...
  // Pick up server-side updates if the parent refetches.
  useEffect(() => {
    setName(initialName);
  }, [initialName]);
